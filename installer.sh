...
# ###########################################
#
# Command: wget https://raw.githubusercontent.com/tarekzoka/oscam/main/Oscam/installer.sh -q; sh installer.sh
#
# ###########################################
...
MY_URL='https://raw.githubusercontent.com/tarekzoka/oscam/main/Oscam/'
